...
function getFinalWidgetCode(map) {
    ...
    var user_api_key = $('#user_api_key').val();
    ...
    var finalWidgetCode = "<script src='https://maps.googleapis.com/maps/api/js?v=3.exp&key=" + user_api_key + "'><\/script>" +
...
$("#get_code_btn").click(function () {
    ...
    _user_api_key.parent().removeClass('has-error');
    var user_api_key = _user_api_key.val();
    if(user_api_key == '') {
        _user_api_key.parent().addClass('has-error');
        return false;
    }
